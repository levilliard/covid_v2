...
export class DialogEdit {
  ...
  ngOnInit() {
    ...
    this.firstFormGroup.patchValue({
      ...
      "dateRetour": this.data["dateRetour"],
    })
    ...
    this._firstFormGroup.patchValue({
      ...
      "dateQuestionNiveau1": this.data["dateQuestionNiveau1"],
    })
    ...
    this.secondFormGroup.patchValue({
      ...
      "dateQuestionNiveau2": this.data["dateQuestionNiveau2"],
